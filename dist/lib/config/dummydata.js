...
Tweet.find({}).remove(function() {
  Tweet.create({
    ...
    author_avatar: 'https://pbs.twimg.com/profile_images/1327824369/kirk3_bigger.jpg',
    created_at: 'Wed Feb 26 23:51:55 +0000 2014',
    text: '~150chars Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque condimentum mollis mauris semper blandit. Mauris varius libero sem, non consectetur elit metus.'
  }, function(err) {
    if (err) {
      console.log(err);
    } else {
